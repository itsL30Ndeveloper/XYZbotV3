...
module.exports = xyz = async (xyz, team) => {
  try {
    ...
    const isUrl = (url) => {
        ...
        //FAKEREPLY PRODUCT
            const ftoko = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "628881372457@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./stik/thumb.jpg`)},"title": `NGEJUDI GAK BROH?\n${pushname}`,"description": "X -team Team", "currencyCode": "IDR","priceAmount1000": "9999999999","retailerId": "XYZteam","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
            //FAKE KONTAK
            const fkontak = { 
            ...
            //FAKE TEXT
            const ftext = {
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "628881372457@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${fake}`,"title": `Hmm`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpg')}}}
            //FAKE LIVE ACTION
            const floc2 = {
            ...
            //FAKEREPLY VIDEO
            const fvideo = {
                  key: {fromMe: false,participant: `628881372457@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '-99999', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpg')}}}
            //FAKEREPLY GROUPINVITE
            const fgc = {
                  key: {"fromMe": false,"participant": "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "62895619083555-1616169743@g.us","inviteCode": "mememteeeekkeke","groupName": "P", "caption": `${fake}`, 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpg')}}}
            //FAKEREPLY GIF
            const fgif = {
                  key: {fromMe: false,participant: `628881372457@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":"hallo bang","h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `${fake}`,'jpegThumbnail': fs.readFileSync('./stik/thumb.jpg')}}} 
...
//FUNCTION
            ...
            xyz.sendMessage(team.key.remoteJid,`@${owner} Sedang Offline!\n\n*Alasan :* ${alasan}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu\n\nSilahkan Hubungi Lagi Nanti`, MessageType.text,{contextInfo:{ mentionedJid: [`${owner}@s.whatsapp.net`],'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': "0@s.whatsapp.net", 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": "*OFFLINE*", 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpg')}}}})
            }
            }   
        if (team.key.remoteJid.endsWith('@g.us') && offline) {
        if (!team.key.fromMe){
...
*Chapter Akhir* : ${komik.chapter_akhir}`
            ...
            break
            case 'asmaulhusna':
anu = await fetchJson(`https://xyz-api.herokuapp.com/muslim/asmaulhusna`)
...
get_result = await fetchJson(`https://xyz-api.herokuapp.com/kisahnabi?nabi=${q}`)
...
case 'doaharian':
anu = await fetchJson(`https://xyz-api.herokuapp.com/muslim/doaharian`)
           teks = `*◪* *DOA HARIAN*\n\n`
...
case 'ayatkursi':
anu = await fetchJson(`https://xyz-api.herokuapp.com/muslim/ayatkursi`)
            oi = anu.result.data
...
case 'bacaanshalat':
anu = await fetchJson(`https://xyz-api.herokuapp.com/muslim/bacaanshalat`)
           teks = `*╔❏* *BACAAN SHALAT*\n\n`
...
var teks = body.slice(8)
                       t1 = teks.split('|')[0]
                       t2 = teks.split('|')[1]
get_result = await fetchJson(`https://xyz-api.herokuapp.com/hadits?kitab=${t1}&nomor=${t2}`)
...
break
case 'tahlil':
anu = await fetchJson(`https://xyz-api.herokuapp.com/muslim/tahlil`)
        ...
        break
        case 'doawirid':
anu = await fetchJson(`https://xyz-api.herokuapp.com/muslim/wirid`)
        ...
        case 'jadwalsholat':
                    ...
                    daerah = args.join(" ")
                    get_result = await fetchJson(`https://xyz-api.herokuapp.com/jsholat?daerah=${daerah}`)
                    ...
                    break
                    case 'niatsholat':
anu = await fetchJson(`https://xyz-api.herokuapp.com/muslim/niatshalat`)
    ...
    case 'chara':
     ...
     case 'waifu':
     reply(mess.wait)
waifu = await getBuffer(`https://xyz-api.herokuapp.com/waifu`)
xyz.sendMessage(from, waifu, image, {quoted: ftroli})
break
case 'loli':
reply(mess.wait)
loli = await getBuffer(`https://xyz-api.herokuapp.com/loli`)
xyz.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'sagiri':
reply(mess.wait)
loli = await getBuffer(`https://xyz-api.herokuapp.com/sagiri`)
xyz.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'neko':
reply(mess.wait)
loli = await getBuffer(`https://xyz-api.herokuapp.com/neko`)
xyz.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'megumin':
reply(mess.wait)
loli = await getBuffer(`https://xyz-api.herokuapp.com/megumin`)
xyz.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'nsfwneko':
reply(mess.wait)
loli = await getBuffer(`https://xyz-api.herokuapp.com/nsfw/neko`)
xyz.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'nsfwwaifu':
reply(mess.wait)
loli = await getBuffer(`https://xyz-api.herokuapp.com/nsfw/waifu`)
xyz.sendMessage(from, loli, image, {quoted: ftroli})
break
case 'wallpaperanime':
reply(mess.wait)
loli = await getBuffer(`https://xyz-api.herokuapp.com/wpnime`)
xyz.sendMessage(from, loli, image, {quoted: ftroli})
break

case 'husbu':
reply(mess.wait)
tod = await fetchJson(`https://xyz-api.herokuapp.com/husbu`)
tid = await getBuffer(tod.url)
xyz.sendMessage(from, tid, image, {quoted: ftroli})
break
case 'quotes':
reply(mess.wait)
tod = await fetchJson(`https://xyz-api.herokuapp.com/randomquote`)
reply(tod.quote.quotes)
break
case 'faktaunik':
reply(mess.wait)
tod = await fetchJson(`https://xyz-api.herokuapp.com/fakta`)
reply(tod.result)
break
case 'quotesbucin':
reply(mess.wait)
bucin = await fetchJson(`https://xyz-api.herokuapp.com/katabucin`)
reply(bucin.result)
break
case 'quotesmuslim':
reply(mess.wait)
tod = await fetchJson(`https://xyz-api.herokuapp.com/randomquote/muslim`)
reply(tod.result.text_id)
break
case 'quoteskanye':
reply(mess.wait)
tod = await fetchJson(`https://xyz-api.herokuapp.com/quotes/kanye`)
reply(tod.result.text_id)
break

case 'wallpaper':
reply(mess.wait)
tod = await fetchJson(`https://xyz-api.herokuapp.com/random/wallpaper`)
...
tod = await fetchJson(`https://xyz-api.herokuapp.com/tiktod/stalk/?username=${q}`)
tid = tod.result.user
...
anu = await fetchJson(`https://xyz-api.herokuapp.com/google?q=${q}`)
...
\nLINK : ${co.link}\n`
        ...
        break
case 'caklontong':
tod = await fetchJson(`https://xyz-api.herokuapp.com/kuis/caklontong?apikey=MASUKAN_APIKEY`)
tid = tod.result.soal
...
break
case 'tebakgambar':
tod = await fetchJson(`https://xyz-api.herokuapp.com/kuis/tebakgambar?apikey=MASUKAN_APIKEY`)
...
titid = await getBuffer(`https://xyz-api.herokuapp.com/canvas/${command}?url=${anu}`)               
  ...
  case 'self':
    ...
    if (!team.key.fromMe && !isOwner) return reply (mess.owner)
      ...
      case 'vnlist':
        ...
        try {
        buffer = fs.readFileSync(`./temp/foto/${namastc}.jpeg`)
        xyz.sendMessage(from, buffer, image, { quoted: team, caption: `Result From Database : ${namastc}.jpeg` })
        } catch {
          reply('Pack tidak terdaftar')
        }
        break
...
tod = await fetchJson(`https://xyz-api.herokuapp.com/short/tiny?url=${q}`)
...
break
  ...
  case 'ping':
    ...
    reply(mess.wait)
    tod = await getBuffer(`https://xyz-api.herokuapp.com/nulis?text=${q}`)
